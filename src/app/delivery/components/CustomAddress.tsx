...
const CustomAddress = ({ closeCustomAddressModal }) => {
  ...
  return (
    <div className='fixed left-0 top-0 flex h-full w-full items-center justify-center bg-black bg-opacity-50'>
      <div className='w-96 rounded-md bg-white p-8' style={{ width: '50%' }}>
        ...
        <div className='mb-4'>
          <label className='block  text-gray-400'>Additional Information</label>
          <input
            type='text'
            className='w-full rounded-md border px-3 py-2'
        ...
        >
          <button
            ...
            style={{ width: '100%' }}
            onClick={closeCustomAddressModal}
          >
            Cancel
          </button>
          <button
