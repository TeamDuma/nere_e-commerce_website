          ...
          <div className='sm:rounded-4xl w-full max-w-md overflow-y-auto bg-white p-4'>
            ...
            <div className='my-4'>
              ...
              <div className='my-4 flex justify-around'>
                ...
                {/*WHATSAPP ICON*/}
                <a href={`whatsapp://send?text=${encodeURIComponent(`I am buying ${group.product?.name} at a good price on Nere. Please click this link to join my group: \n${process.env.NEXT_PUBLIC_APP_URL}/groups/ongoingPurchases/${group.uid}`)}`}>
              ...
              <div className='mt-4 flex items-center justify-between border-2 border-gray-200 py-2'>
                ...
                <input
                  ...
                  type='text'
                  placeholder='link'
                  defaultValue={`${process.env.NEXT_PUBLIC_APP_URL}/groups/ongoingPurchases/${group.uid}`}
                />
                <button
